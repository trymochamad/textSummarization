...
public class CosineSimilarity {
    ...
    public double Cosine_Similarity_Score(String Text1, String Text2){
     ...
     public void selectSentences (Notulen not){
         StringBuilder result = new StringBuilder(); 
         for (int i = 0; i < not.getPembicara().size(); i++){
             for (int j = 0; j < not.getIsiInterupsi().get(i).size(); j++){
                 String s = not.getIsiInterupsi().get(i).get(j);
                 result.append (s + " ");
             }
         }
     ...
     public double calcStcSimilarity (TreeMap<String,Integer> tm1, double pjg1,  TreeMap<String,Integer> tm2, double pjg2) {
    ...
    public static void main(String[] args)
    {
          ...
          double sim_score = cs1.Cosine_Similarity_Score("Julie loves me more", "Jul loves me more loves");
          //double similarity_score = cs1.calcStcSimilarity(tm1, sim_score, tm2, sim_score)
